...
-- ============================================
-- MIGRATION 3: Sistema de Entrevistas com IA
-- ============================================
...
DROP TRIGGER IF EXISTS trigger_update_job_interviews_updated_at ON public.job_interviews;
...
DROP POLICY IF EXISTS "Admins can view all interviews" ON public.job_interviews;
...
DROP POLICY IF EXISTS "Admins can manage interviews" ON public.job_interviews;
...
DROP POLICY IF EXISTS "System can manage interviews" ON public.job_interviews;
