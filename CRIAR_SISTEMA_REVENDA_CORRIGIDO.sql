-- =====================================================
-- SISTEMA DE REVENDA MULTI-TENANT (VERSÃO CORRIGIDA)
-- Estrutura para revender o sistema para outras empresas
-- =====================================================
...
-- 3. Tabela de Assinaturas (DROP se existir sem company_id e recriar)
DO $$
BEGIN
...
SELECT 'Sistema de revenda criado com sucesso!' AS resultado;
