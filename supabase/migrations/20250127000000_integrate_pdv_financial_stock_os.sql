-- ============================================
-- INTEGRAÇÃO PDV COM FINANCEIRO, ESTOQUE E OS
-- ============================================

-- ============================================
-- 1. ADICIONAR CAMPOS NA TABELA SALES
-- ============================================
...
-- ============================================
-- 3. FUNÇÃO PARA INTEGRAR VENDA AO FINANCEIRO
-- ============================================
...
-- ============================================
-- 4. FUNÇÃO PARA REVERTER ESTOQUE (CANCELAMENTO)
-- ============================================
...
BEGIN
  ...
  -- Verificar se a OS existe (pode estar em localStorage, então apenas verificar se tem referência)
  -- Se a OS existe no banco, atualizar
  -- Como a OS pode estar em localStorage, vamos apenas marcar a venda como OS faturada
  -- A atualização da OS será feita no frontend quando necessário
...
-- ============================================
-- 6. FUNÇÃO PARA ATUALIZAR CONTA A RECEBER QUANDO PAGAMENTO É CONFIRMADO
-- ============================================
...
-- ============================================
-- 7. TRIGGER PARA INTEGRAR AUTOMATICAMENTE AO FINALIZAR VENDA
-- ============================================
...
-- ============================================
-- 8. TRIGGER PARA ATUALIZAR CONTA A RECEBER QUANDO PAGAMENTO É CONFIRMADO
-- ============================================
