-- Script simplificado para criar tabela time_clock
-- Execute: sudo -u postgres psql -d banco_gestao -f CRIAR_TIME_CLOCK_SIMPLES.sql
...
-- Verificar resultado
SELECT 'Tabela time_clock OK!' AS status;
