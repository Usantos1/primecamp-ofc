-- ==========================================
-- APLICAR TODAS AS FUNÇÕES PARA IMPORTAÇÃO
-- ==========================================
-- Execute este script no Supabase SQL Editor
-- para criar todas as funções necessárias para importação rápida

-- 1. Função para bulk upsert de produtos
...
-- 2. Função para buscar produtos por lista de nomes (case-insensitive)
...
WHERE routine_schema = 'public' 
  AND routine_name IN ('bulk_upsert_produtos', 'buscar_produtos_por_nomes')
