...
VALUES
  ...
  ('rh.nova_candidatura', 'comercial', 'Nova candidatura à vaga', 'Candidato concluiu formulário público de vaga', ARRAY['vaga_titulo','vaga_cargo','empresa','candidato_nome','candidato_email','candidato_telefone','candidato_whatsapp','candidato_idade','candidato_cep','candidato_endereco','candidato_instagram','candidato_linkedin','protocolo_id','perguntas_respostas'], 'tempo_real', true,
