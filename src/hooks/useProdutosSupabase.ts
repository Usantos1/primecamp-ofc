...
function mapSupabaseToAssistencia(supabaseProduto: any): Produto {
  return {
    ...
    // Preço (BRL)
    valor_compra: Number(supabaseProduto.valor_compra || supabaseProduto.vi_compra || supabaseProduto.vi_custo || 0),
    valor_venda: Number(supabaseProduto.valor_venda || supabaseProduto.valor_dinheiro_pix || 0),
    ...
    preco_custo: Number(supabaseProduto.valor_compra || supabaseProduto.vi_compra || supabaseProduto.vi_custo || 0),
    preco_venda: Number(supabaseProduto.valor_venda || supabaseProduto.valor_dinheiro_pix || 0),
