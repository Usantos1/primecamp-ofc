...
export function OSSummaryHeader({
  ...
  return (
    <Card className="sticky top-0 z-10 border-b-2 shadow-sm mb-4">
      <CardContent className="p-3">
        {/* Número da OS - destaque no topo */}
        {numeroOS && (
          <div className="mb-3 pb-3 border-b">
            <h2 className="text-lg font-bold text-primary">OS #{numeroOS}</h2>
          </div>
        )}
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-3 items-center">
          {/* Cliente */}
          <div className="flex items-center gap-2 min-w-0">
            <User className="h-4 w-4 text-muted-foreground flex-shrink-0" />
            <div className="min-w-0">
              <p className="text-xs text-muted-foreground">Cliente</p>
              <p className="text-sm font-medium truncate">{clienteNome || 'Não informado'}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-sm font-medium truncate">{modeloNome || 'Não informado'}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-sm font-medium truncate">{tecnicoNome || 'Não atribuído'}</p>
            </div>
          </div>
        </div>
