  ...
  return (
    ...
    >
      <div className="flex flex-col h-full overflow-hidden">
        {/* Indicadores Financeiros - FIXO NO TOPO */}
        {isGestor && financialData && (
          <div className="flex-shrink-0 px-1 md:px-0 pb-4 border-b bg-background">
        ...
        {/* Conteúdo com scroll */}
        <div className="flex-1 overflow-y-auto scrollbar-thin px-1 md:px-0 pt-4">
